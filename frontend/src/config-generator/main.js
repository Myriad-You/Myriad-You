...
//
// 官网移植版：已移除 tapp 沙箱宿主（Tapp.api / Tapp.file / Tapp.ui / 生命周期桥接），
// 网络直连公共 API，通知走站内 Toast，由 ConfigGeneratorModal 挂载/卸载。
...
async function fetchDockerHubTags(repo) {
  // 官网环境直连 Docker Hub 公共 API（沙箱 Tapp.api 通道已移除）
 ...
 */
export function mountConfigGenerator() {
  initPage();
}
